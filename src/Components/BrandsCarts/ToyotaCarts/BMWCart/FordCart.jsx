...
import FordSlider from "../../../../SliderInBrandCart/FordSlider";
            ...
            <div>
                {
                    fordFilter.length === 0 ? <div className="mx-auto text-center flex flex-col justify-center items-center">
                        ...
                        fordFilter.map(fordMap => <div className="grid grid-cols-3 max-w-screen-xl mx-auto gap-4 mt-5" key={fordMap._id}>
