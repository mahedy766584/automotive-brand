...
const MyCart = () => {
    ...
    const handleDelete = (_id) => {
        ...
        fetch(`https://automotive-brand-server.vercel.app/myCart/${_id}`, {
            method: "DELETE"
        })
            .then(res => res.json())
            .then(data => {
                                ...
                                <div className="flex py-10 px-6 mt-5 flex-col gap-10 items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row">
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div className="flex  gap-10 mt-3 items-center">
                                            ...
                                            <button
                                                className="uppercase text-xs font-semibold font-poppins border-2 border-red-600 text-red-600 px-6 py-2 rounded">Buy Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
